...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const secretNotes = {
        ...
        "ОТЕЦ": {
            title: "Из переписки Джес с отцом",
            text: "Джес: Пап.. Я больше так не могу, сколько нам ещё придётся скрываться и скрывать свои истинные имена? И к слову, тот парень с фиолетовыми волосами, он кричал, что ему нужен этот лысый, и мне кажется, что на этот раз пришли не за мной... Боже, как же меня всё это надоело... Я больше так не могу... Я столько раз уже сменяла экипаж, это правда плохо на мне сказывается..."
        }
